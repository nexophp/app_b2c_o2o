...
<div class="login-wrapper">
    ...
    <div class="login-container">
        <div class="login-header">
            <div class="login-title"><?=lang('手机验证码登录')?></div>
            <div class="login-subtitle"><?=lang('请输入手机号和验证码')?></div>
        </div>
...
$vue->method("login()", "
    ...
    this.loading = true;
    ajax('/admin/login/phone-login', this.form, function(res) {
        " . vue_message() . "
        if (res.code == 0) {
           setTimeout(function() {
