...
class AlipayRefund
{
     ...
     * @return bool
     */
    public static function run($outTradeNo, $refundAmount)
    {
        /*** 请填写以下配置信息 ***/
        $appid = get_config("alipay_appid");  //https://open.alipay.com 账户中心->密钥管理->开放平台密钥，填写添加了电脑网站支付的应用的APPID
        ...
        if ($result['code'] && $result['code'] == '10000') {
            ...
            $err = $result['msg'] . ' : ' . $result['sub_msg'];
            add_log("支付宝退款失败", $err, 'error');
            return false;
        }
    }
}
